...
const Report = () => {
  ...
  return (
    <KeyboardAvoidingView
      ...
      style={{ flex: 1 }}
    >
      <ScrollView className="flex-1 px-6 bg-background-light">
        <Text className="mt-10 text-2xl font-bold">Which Fountain?</Text>

        <View className="flex-row items-center justify-between p-1 mt-5 bg-gray-200 rounded-full">
          <TouchableOpacity
            activeOpacity={0.8}
            onPress={() => {
              setActiveTab('list')
        ...
        {showCamera ? (
          <View className="mt-6 h-[400px]  overflow-hidden rounded-xl border border-gray-500">
            ...
            <View className="absolute w-64 h-64 -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
          ...
          <>
            <TextInput
              className="px-5 py-4 border border-gray-300 rounded-full mt-7"
            ...
            <TextInput
              className="px-5 py-4 text-lg border border-gray-300 rounded-lg mt-7"
            ...
            <TouchableOpacity
              onPress={openCamera}
              className="items-center justify-center gap-2 mt-3 border border-gray-400 border-dashed rounded-xl"
              style={{ height: 170 }}
              activeOpacity={0.7}
            >
              {photo ? (
            ...
            <TouchableOpacity
              activeOpacity={0.8}
              className="items-center py-4 mt-10 mb-10 shadow-md bg-primary rounded-xl shadow-black"
